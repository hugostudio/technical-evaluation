...
import com.hugo.cursomc.domain.Pagamento;
import com.hugo.cursomc.domain.PagamentoComBoleto;
import com.hugo.cursomc.domain.PagamentoComCartao;
...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "hugostudio@yahoo.com.br", "36378912377", TipoCliente.PESSOAFISICA, passworEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Hugo Leonardo", "hugostudio@yahoo.com.br", "88948653040", TipoCliente.PESSOAFISICA, passworEncoder.encode("999"));
		cli2.getTelefones().addAll(Arrays.asList("99567958", "32756766"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 30", "Jardins", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Paulista", "1", null, "Centro", "4567456", cli2, c2);
		...
		Pedido ped2 = new Pedido(null, sdf.parse("10/10/2017 109:35"), cli1, e2);
